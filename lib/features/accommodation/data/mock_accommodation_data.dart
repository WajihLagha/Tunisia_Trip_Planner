...
class MockAccommodationData {
  static List<AccommodationDto> get accommodations => [
        AccommodationDto(
          ...
          longitude: 10.1706,
          images: [
            AccommodationImageDto(id: 1, imageUrl: 'assets/images/hotel1.png'), // Replace with actual asset if needed
            AccommodationImageDto(id: 2, imageUrl: 'assets/images/hotel2.png'),
          ],
          rooms: [
            RoomDto(
              id: 1,
              ...
              images: [
                RoomImageDto(id: 1, imageUrl: 'assets/images/room1.png'),
              ],
            ),
            RoomDto(
              id: 2,
              ...
              images: [
                RoomImageDto(id: 2, imageUrl: 'assets/images/room2.png'),
              ],
            ),
          ],
        ),
        AccommodationDto(
          ...
          longitude: 8.6874,
          images: [
            AccommodationImageDto(id: 3, imageUrl: 'assets/images/hotel3.png'),
          ],
          rooms: [
            RoomDto(
              id: 3,
              ...
              images: [
                RoomImageDto(id: 3, imageUrl: 'assets/images/room3.png'),
              ],
            ),
          ],
        ),
        AccommodationDto(
          ...
          longitude: 10.6084,
          images: [
            AccommodationImageDto(id: 4, imageUrl: 'assets/images/hotel4.png'),
          ],
          rooms: [
            RoomDto(
              id: 4,
              ...
              images: [
                RoomImageDto(id: 4, imageUrl: 'assets/images/room4.png'),
              ],
            ),
          ],
        ),
        AccommodationDto(
          ...
          longitude: 10.3340,
          images: [
            AccommodationImageDto(id: 5, imageUrl: 'assets/images/hotel1.png'),
          ],
          rooms: [
            RoomDto(
              id: 5,
              ...
              images: [
                RoomImageDto(id: 5, imageUrl: 'assets/images/room1.png'),
              ],
            ),
          ],
        ),
  ...
  static List<RoomDto> get topRooms {
    ...
    // Assuming the ones with images are the ones we want to showcase
